          ...
          <section className="relative">
            ...
            <div className="comment_group px-4">
              ...
              <div className="followingnumber mt-4 ">
                <h4 className="text-xl text-gray-1000 ">
                ...
                <div className="flex items-center max-w-[85%]">
                  ...
                  {/* <p
                    className={
                      moreEvent === true
                        ? "text-left"
                        : "truncate text-left max-w-[60vw] pl-2"
                    }
                  >
                    Imperdiet in
                    sitsdfsdfsdfsdfsfsdfdsdfsdfsdfsdfsdfsdfsdfsdfsfsdfdsdfsdfsdfsdfsdfsdfsdfsdfsfsdfsefsefsfesefsefsefsefsefdsdfsdfsdfsdfsdfsd
                  </p> */}
                  {postData.caption}
                </div>
                <div>
                  {/* <button onClick={() => setMoreEvent(!moreEvent)}>
                    {moreEvent ? "less" : "more"}
                  </button> */}
                  <span 
            ...
            <form className="mt-4">
              ...
              <div className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                <button
                  ...
                  onClick={(event) => handleEmoji(event, `${postData.postID}`)}
                >
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
